...
1.) Start Firefox.
2.) Open the 'NRLOrderIt-X.X.X.xpi' file within Firefox, 'File->Open File...' (Ctrl+O), 
...
Version 0.3.8 add compatibility for Firefox 10.*. There are no bug fixes or additional features included
in this update. Firefox now does not disable extensions by default when updating, so this version will
also work with major releases of Firefox as well.