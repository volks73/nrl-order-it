...
/**
 * The <code>JobOrderNumber.Toolbar</code> module.
 */
mil.navy.nrl.NRLOrderIt.JobOrderNumber.Toolbar = (function () {
	
	/*
	 * Private members.
	 */
	
	var _logger = Log4Moz.repository.getLogger("NRLOrderIt.JobOrderNumber.Toolbar"); 
	...
	return {
		...
		get ID() {
			return _NRLOrderIt.JobOrderNumber.NAMESPACE + _NRLOrderIt.NAMESPACE_SEPARATOR + 'Toolbar';
		},
		...
		/**
		 * Fired to add a new job order number.
		 */
		get ADD_EVENT() {
		...
		/**
		 * Fired to remove an existing job order number.
		 */
		get REMOVE_EVENT() {
		...
		/**
		 * Fired to search for an existing job order number.
		 */
		get SEARCH_EVENT() {
		...
		/**
		 * Sends a <code>SEARCH_EVENT</code> notification.
		 */
		search : function() {
