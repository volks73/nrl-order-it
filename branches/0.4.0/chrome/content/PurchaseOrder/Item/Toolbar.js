...
/**
 * The <code>Item.Toolbar</code> module.
 */
mil.navy.nrl.NRLOrderIt.PurchaseOrder.Item.Toolbar = (function () {
	
	/*
	 * Private variables.
	 */
	
	var _logger = Log4Moz.repository.getLogger("mil.navy.nrl.NRLOrderIt.PurchaseOrder.Item.Toolbar"); 
	...
	return {
		...
		get ID() {
			return _NRLOrderIt.PurchaseOrder.Item.NAMESPACE + _NRLOrderIt.NAMESPACE_SEPARATOR + 'Toolbar';
		},
		...
		get REMOVEALL_TOOLBARBUTTON_ID() {
			return this.ID + _NRLOrderIt.NAMESPACE_SEPARATOR + 'RemoveAll';
		},
		...
		/**
		 * Fired to edit an existing item.
		 */
		get EDIT_EVENT() {
		...
		/**
		 * Fired to remove an existing item.
		 */
		get REMOVE_EVENT() {
		...
		/**
		 * Fired to remove all items.
		 */
		get REMOVE_ALL_EVENT() {
			return this.EVENT_ID + _NRLOrderIt.NAMESPACE_SEPARATOR + 'RemoveAll';
		},
		...
		/**
		 * Sends a <code>REMOVE_ALL_EVENT</code> notification.
		 */
		removeAll : function () {
			_logger.trace("removeAll opened");
			
			_observerService.notifyObservers(this, this.REMOVE_ALL_EVENT, null);
			
			_logger.trace("removeAll closed");
		}
	}
})();