...
/**
 * The <code>JobOrderNumber.Menu</code> module.
 */
mil.navy.nrl.NRLOrderIt.JobOrderNumber.Menu = (function () {

	/*
	 * Private variables.
	 */
	
	var _logger = Log4Moz.repository.getLogger("mil.navy.nrl.NRLOrderIt.JobOrderNumber.Menu"); 
	...
	return {
		...
		get ID() {
			return _NRLOrderIt.JobOrderNumber.NAMESPACE + _NRLOrderIt.NAMESPACE_SEPARATOR + 'Menu';
		},
		...
		/**
		 * Fired to a new job order number.
		 */
		get ADD_EVENT() {
