...
/**
 * The <code>Item.Menu</code> module.
 */
mil.navy.nrl.NRLOrderIt.PurchaseOrder.Item.Menu = (function () {

	/*
	 * Private variables.
	 */
	
	var _logger = Log4Moz.repository.getLogger("mil.navy.nrl.NRLOrderIt.PurchaseOrder.Item.Menu"); 
	...
	return {
		...
		get ID() {
			return _NRLOrderIt.PurchaseOrder.Item.NAMESPACE + _NRLOrderIt.NAMESPACE_SEPARATOR + 'Menu';
		},
